...
# Nodes
[image="dingoimg:latest" type=openswitch name="OpenSwitch 1"] ops1
[image="dingoimg:latest" type=openswitch name="OpenSwitch 2"] ops2
...
line1 = "The use of COBOL crippes the mind;"

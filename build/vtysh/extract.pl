...
foreach (@ARGV) {
    ...
    open (FH, "x86_64-openhalon-linux-gcc -E --sysroot=/ws/gurg/halon_dir/build/tmp/sysroots/as5712  -m64 -march=core2 -mtune=core2 -msse3 -mfpmath=sse -DHAVE_CONFIG_H -DVTYSH_EXTRACT_PL -DHAVE_IPV6 -I.. -I/ws/gurg/halon_dir/src/cli/vtysh/ -I/ws/gurg/halon_dir/src/cli/vtysh/.. -I/ws/gurg/halon_dir/src/cli/lib -I../lib -I/ws/gurg/halon_dir/src/cli/isisd/topology  $file |");
    local $/; undef $/;
    $line = <FH>;
    close (FH);

...
/*Function to set AAA fallback option. */
static int
...
/*Function to show AAA Authentication configuration. */
static int
...
/*Function to add RADIUS server host.*/
static int
radius_server_add_host(const char *ipv4)
{
    ...
    ovsrec_open_vswitch_set_radius_servers(ovs,
 ...
 * On success removes auth-port and sets to default auth-port 1812.
 */
static int
...
/*
 * Removes RADIUS server secret key. On success removes configured
 * 'passkey' and sets 'passkey' to default value.
 */
static int
...
/* Function to remove RADIUS server host. */
static int
...
/*Function to set secret key for the host.*/
static int
...
/*Function to set RADIUS server retries.*/
static int
...
/* Removes the RADIUS server retreis and sets to default. */
static int
...
/*Function to set RADIUS server timeout. */
static int
...
/*Removes RADIUS server timeouts and sets to default.*/
static int
...
/*Function to set RADIUS server authentication port for the given host.*/
static int
...
/*Function to set ssh public key aythentication status.*/
static int
...
/*Sets ssh password authentication.*/
static int

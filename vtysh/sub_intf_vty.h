...
#define MIN_SUB_INTF                    1
#define MAX_SUB_INTF                    1024
#define MIN_LOOP_INTF                   1
#define MAX_LOOP_INTF			1024
#define SUB_INTERFACE_NAME_LENGTH       11
...
#define SUB_INTERFACE_NAME_LENGTH      10

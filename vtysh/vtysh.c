...
/* This api loads the rbac library and checks if the username passed
 * contains the permission passed in the function*/
...
/* #endif */
  ...
  pw = getpwuid( getuid());
  if (pw && (rbac_check_user_permission(pw->pw_name, RBAC_SYS_MGMT)))
  {

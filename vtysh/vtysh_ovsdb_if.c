...
ospf_ovsdb_init()
{
    ...
    ovsdb_idl_add_column(idl, &ovsrec_ospf_router_col_ospf_restart);
    ...
    ovsdb_idl_add_column(idl,
                        &ovsrec_ospf_nbma_neighbor_config_col_nbr_address);
    ovsdb_idl_add_column(idl,
                        &ovsrec_ospf_nbma_neighbor_config_col_interface_name);
    ovsdb_idl_add_column(idl,
                        &ovsrec_ospf_nbma_neighbor_config_col_status);
    ovsdb_idl_add_column(idl,
                        &ovsrec_ospf_nbma_neighbor_config_col_nbr_router_id);
    ovsdb_idl_add_column(idl,
                        &ovsrec_ospf_nbma_neighbor_config_col_other_config);

...
ntp_ovsdb_init()
{
    ...
    /* Add NTP Keys Table */
    ovsdb_idl_add_table(idl, &ovsrec_table_ntp_keys);

    /* Add columns in NTP Keys Table */
    ovsdb_idl_add_column(idl, &ovsrec_ntp_keys_col_key_id);
    ovsdb_idl_add_column(idl, &ovsrec_ntp_keys_col_key_password);
    ovsdb_idl_add_column(idl, &ovsrec_ntp_keys_col_trust_enable);
}

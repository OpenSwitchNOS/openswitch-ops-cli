...
ospf_ovsdb_init()
{
    ...
    ovsdb_idl_add_column(idl, &ovsrec_ospf_area_col_auth_config);
    ...
    ovsdb_idl_add_column(idl, &ovsrec_ospf_interface_config_col_auth_config);
    ovsdb_idl_add_column(idl, &ovsrec_ospf_interface_config_col_nbma_nbr_config);
    ovsdb_idl_add_column(idl, &ovsrec_ospf_interface_config_col_ospf_if_config);
    ...
    ovsdb_idl_add_column(idl, &ovsrec_ospf_vlink_col_auth_config);
...
ovsdb_init(const char *db_path)
{
    ...
    /* Add features column. */
    ovsdb_idl_add_column(idl, &ovsrec_system_col_features);

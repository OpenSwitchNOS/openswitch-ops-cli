...
bgp_ovsdb_init()
{
    ...
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_flags);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_weight);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_local_pref);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_aggregator_as);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_protocol_internal);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_protocol_ibgp);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_aspath);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_origin);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_uptime);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_aggregator_addr);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_atomic_aggregate);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_community);
    ovsdb_idl_add_column(idl, &ovsrec_bgp_route_col_ecommunity);

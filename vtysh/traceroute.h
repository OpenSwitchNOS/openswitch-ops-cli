...
#define TRACEROUTE_HOST                 "Enter Hostname of the device to traceroute\n"
...
#define MAXTTL_INPUT                    "Enter maximum ttl value\n"
#define MINTTL_INPUT                    "Enter minimum ttl value\n"
#define TIMEOUT_INPUT                   "Enter timeout value\n"
#define PROBES_INPUT                    "Enter probes value\n"
#define DSTPORT_INPUT                   "Enter destination port value\n"

...
#define OSPF_PATH_INTER_AREA        "inter_area"
#define OSPF_PATH_INTRA_AREA        "intra_area"
#define OSPF_PATH_EXTERNAL          "external"

#define OSPF_EXT_TYPE_1             "ext_type_1"
#define OSPF_EXT_TYPE_2             "ext_type_2"

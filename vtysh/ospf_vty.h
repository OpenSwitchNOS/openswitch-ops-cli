...
#define OSPF_ROUTER_ID_STR  "Configure router identifier for the OSPF process\n"
#define OSPF_ROUTER_ID_VAL_STR  "OSPF router-id in IP address format\n"
#define NEIGHBOR_ID_STR     "Enter the neighbor router id\n"

...
def setHelloIntervalTest(dut01):
    ...
    assert hello_time == 25, "Test to set hello interval failed"
...
def unsetHelloIntervalTest(dut01):
    ...
    hello_time = getTimers(dut01, "Hello")
    assert hello_time == 10, "Test to unset hello interval failed"
...
def setDeadIntervalTest(dut01):
    ...
    dead_time = getTimers(dut01, "Dead")
    assert dead_time == 50, "Test to set dead interval failed"
...
def unsetDeadIntervalTest(dut01):
    ...
    dead_time = getTimers(dut01, "Dead")
    assert dead_time == 40, "Test to unset dead interval failed"

...
''')
        ...
        expected_output = \
            'Error: No secondary IP Address configured on interface ' \
            + first_interface
        assert expected_output in ret, \
...
''')
        ...
        assert 'Error: IPv6 Address 2004::1/120 not found.' in ret, \
        ...
        ipv6 = s1.ovscmd(intf_cmd).strip()
        assert ipv6 == '[2001::2/120, 2001::3/120]', \
...
''')
        ...
        assert 'ip address 10.1.1.1/8' in output[intf2_output + 1] \
            ...
            in output[intf2_output + 2] and 'ipv6 address 2002::1/120' \

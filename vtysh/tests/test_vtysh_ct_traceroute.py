...
def setTracerouteIpTest(dut01):
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute 1.1.1.1")
...
def setTracerouteHostTest(dut01):
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute localhost")
...
def setTracerouteIpMaxttlTest(dut01):
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute 1.1.1.1 maxttl 30")
...
localhost maxttl 30")
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute localhost maxttl 30")
...
def setTracerouteIpMinttlTest(dut01):
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute 1.1.1.1 minttl 1")
...
minttl 1")
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute localhost minttl 1")
    assert 'localhost' in cmdOut, "Test to set traceroute target \
host minttl failed"
...
dstport 33434")
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute localhost dstport 33434")
    assert 'localhost' in cmdOut, "Test to set traceroute target \
host dstport failed"
...
dstport 33434")
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute 1.1.1.1 dstport 33434")
    assert '1.1.1.1' in cmdOut, "Test to set traceroute \
...
localhost probes 3")
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute localhost probes 3")
    assert 'localhost' in cmdOut, "Test to set traceroute target \
host probes failed"
...
def setTracerouteIpProbesTest(dut01):
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute 1.1.1.1 probes 3")
    assert '1.1.1.1' in cmdOut, "Test to set traceroute target \
ip probes failed"
...
localhost timeout 3")
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute localhost timeout 3")
    assert 'localhost' in cmdOut, "Test to set traceroute target \
host timeout failed"
...
def setTracerouteIpTimeoutTest(dut01):
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute 1.1.1.1 timeout 3")
    assert '1.1.1.1' in cmdOut, "Test to set traceroute target \
ip timeout failed"
...
ip-option loosesourceroute 1.1.1.8")
    retCode = devIntReturn.get('returnCode')
    assert retCode == 0, "Test to set traceroute target ip-options failed"
    cmdOut = dut01.cmdVtysh(command="traceroute 1.1.1.1 ip-option \
loosesourceroute 1.1.1.8")
    assert '1.1.1.1' in cmdOut, "Test to set traceroute target \
...
ip-option loosesourceroute 1.1.1.8")
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute localhost ip-option \
loosesourceroute 1.1.1.8")
    assert 'localhost' in cmdOut, "Test to set traceroute target \
...
def setTraceroute6IpTest(dut01):
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute6 0:0::0:1")
...
def setTraceroute6HostTest(dut01):
    ...
    retCode = devIntReturn.get('returnCode')
    assert retCode == 0, "Test to set traceroute target6 host failed"
    cmdOut = dut01.cmdVtysh(command="traceroute6 localhost")
...
maxttl 30")
    ...
    cmdOut = dut01.cmdVtysh(command="traceroute6 0:0::0:1 maxttl 30")
...
timeout 3")
    retCode = devIntReturn.get('returnCode')
    assert retCode == 0, "Test to set traceroute target ip timeout failed"
    cmdOut = dut01.cmdVtysh(command="traceroute6 0:0::0:1 timeout 3")
    assert '0:0::0:1' in cmdOut, "Test to set traceroute6 target \
ip timeout failed"
...
timeout 3")
    retCode = devIntReturn.get('returnCode')
    assert retCode == 0, "Test to set traceroute target hostname \
timeout failed"
    cmdOut = dut01.cmdVtysh(command="traceroute localhost timeout 3")
...
probes 3")
    retCode = devIntReturn.get('returnCode')
    assert retCode == 0, "Test to set traceroute target ip probes failed"
    cmdOut = dut01.cmdVtysh(command="traceroute6 0:0::0:1 probes 3")
    assert '0:0::0:1' in cmdOut, "Test to set traceroute6 target \
ip probes failed"
...
probes 3")
    retCode = devIntReturn.get('returnCode')
    assert retCode == 0, "Test to set traceroute target hostname probes failed"
    cmdOut = dut01.cmdVtysh(command="traceroute localhost probes 3")
    assert 'localhost' in cmdOut, "Test to set traceroute6 target \
...
dstport 33434")
    retCode = devIntReturn.get('returnCode')
    assert retCode == 0, "Test to set traceroute target ip dstport failed"
    cmdOut = dut01.cmdVtysh(command="traceroute6 0:0::0:1 dstport 33434")
    assert '0:0::0:1' in cmdOut, "Test to set traceroute6 target \
ip dstport failed"

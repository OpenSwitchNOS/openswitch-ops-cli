...
class TracerouteTest(OpsVsiTest):
    ...
    def traceroute6_target_ipv6(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 0:0::0:1' in line:
    ...
    def traceroute6_target_maxttl(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 0:0::0:1 maxttl 30' in line:
    ...
    def traceroute6_target_dstport(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 0:0::0:1 dstport 33434' in line:
    ...
    def traceroute6_target_probes(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 0:0::0:1 probes 3' in line:
    ...
    def traceroute6_target_timeout(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 0:0::0:1 timeout 3' in line:
    ...
    def traceroute6_target_host(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 localhost' in line:
    ...
    def traceroute6_targethost_maxttl(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 localhost maxttl 30' in line:
    ...
    def traceroute6_targethost_dstport(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 localhost dstport 33434' in line:
    ...
    def traceroute6_targethost_probes(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 localhost probes 3' in line:
                traceroute6_target_probes_set = True
        assert(traceroute6_target_probes_set is True), \
            'Test setting traceroute6 target probes -FAILED!'
    ...
    def traceroute6_targethost_timeout(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 localhost timeout 3' in line:

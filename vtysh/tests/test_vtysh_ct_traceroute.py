...
class TracerouteTest(OpsVsiTest):
    ...
    def setupNet(self):
        ...
        traceroute_topo = SingleSwitchTopo(k=0, hopts=host_opts, sopts=switch_opts)
        self.net = Mininet(traceroute_topo, switch=VsiOpenSwitch,
    ...
    def traceroute_ip(self):
        ...
        ret = s1.cmdCLI("traceroute 1.1.1.1 dstport 34002")
        ...
        ret = s1.cmdCLI("traceroute 1.1.1.1 ip-option loose-source-route 300.300.300.300")
        assert '% invalid IP address.' not in ret, \
            'Traceroute ip-option loose-source-route validation failed'
        info('\n### Traceroute ip ip-option loose-source-route validation passed ###\n')
    ...
    def traceroute_hostname(self):
        ...
        assert '% invalid string.' not in ret, \
            'Traceroute hostname validation failed'
        info('\n### Traceroute hostname validation passed ###\n')

        ret = s1.cmdCLI("traceroute testname dstport 34002")
        assert '% Unknown command.' not in ret, \
            'Traceroute dstport validation failed'
        info('\n### Traceroute hostname dstport validation passed ###\n')

        ret = s1.cmdCLI("traceroute testname maxttl 296")
        assert '% Unknown command.' not in ret, \
            'Traceroute maxttl validation failed'
        info('\n### Traceroute hostname maxttl validation passed ###\n')

        ret = s1.cmdCLI("traceroute testname minttl 260")
        assert '% Unknown command.'not in ret, \
            'Traceroute minttl validation failed'
        info('\n### Traceroute hostname minttl validation passed ###\n')

        ret = s1.cmdCLI("traceroute testname timeout 155")
        assert '% Unknown command.' not in ret, \
            'Traceroute timeout validation failed'
        info('\n### Traceroute hostname timeout validation passed ###\n')

        ret = s1.cmdCLI("traceroute testname probes 60")
        assert '% Unknown command.' not in ret, \
            'Traceroute probes validation failed'
        info('\n### Traceroute hostname probes validation passed ###\n')

        ret = s1.cmdCLI("traceroute testname ip-option loose-source-route 300.300.300.300")
        assert '% invalid IP address.' not in ret, \
            'Traceroute ip-option loose-source-route validation failed'
        info('\n### Traceroute hostname ip-option loose-source-route validation passed ###\n')
    ...
    def traceroute6_ip(self):
        ...
        ret = s1.cmdCLI("traceroute6 1:1::1:1 dstport 34002")
        assert '% Unknown command.'  not in ret, \
        ...
        ret = s1.cmdCLI("traceroute6 1:1::1:1 minttl 296")
        assert '% Unknown command.'not in ret, \
            'Traceroute6 minttl validation failed'
        info('\n### Traceroute6 ip  minttl validation passed ###\n')
    ...
    def traceroute6_hostname(self):
        ...
        ret = s1.cmdCLI("traceroute6 testname dstport 34002")
        assert '% Unknown command.' not in ret, \
            'Traceroute6 dstport validation failed'
        info('\n### Traceroute6 hostname dstport validation passed ###\n')

        ret = s1.cmdCLI("traceroute6 testname maxttl 296")
        assert '% Unknown command.' not in ret, \
            'Traceroute6 maxttl validation failed'
        info('\n### Traceroute6 hostname maxttl validation passed ###\n')

        ret = s1.cmdCLI("traceroute6 testname minttl 260")
        assert '% Unknown command.' not in ret, \
            'Traceroute6 minttl validation failed'
        info('\n### Traceroute6 hostname minttl validation passed ###\n')

        ret = s1.cmdCLI("traceroute6 testname timeout 155")
        assert '% Unknown command.' not in ret, \
            'Traceroute6 timeout validation failed'
        info('\n### Traceroute6 hostname timeout validation passed ###\n')

        ret = s1.cmdCLI("traceroute6 testname probes 60 ")
        assert '% Unknown command.' not in ret, \
            'Traceroute6 probes validation failed'
    ...
    def traceroute_target_dstport(self):
        ...
        info('\n### traceroute target ip dstport verification successfull ###\n')
    ...
    def traceroute_target_probes(self):
        ...
        info('\n### traceroute target ip probes verification successfull ###\n')
    ...
    def traceroute_target_ipoption(self):
        ...
        s1 = self.net.switches[0]
        dump = s1.cmdCLI("traceroute 1.1.1.1 ip-option loosesourceroute 1.1.1.5")
        time.sleep(2)
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute to 1.1.1.1' in line:
    ...
    def traceroute_targethost_maxttl(self):
        ...
        info('\n### traceroute targethost maxttl verification successfull ###\n')


    def traceroute_targethost_dstport(self):
        info('''\n########## Test traceroute targethhost dstport ##########\n''')
        ...
        info('\n### traceroute targethost dstport verification successfull ###\n')
    ...
    def traceroute_targethost_minttl(self):
        ...
        info('\n### traceroute targethost minttl verification successfull ###\n')
    ...
    def traceroute_targethost_probes(self):
        ...
        info('\n### traceroute targethost probes verification successfull ###\n')


    def traceroute_targethost_timeout(self):
        info('''\n########## test traceroute targethost timeout ##########\n''')
        ...
        info('\n### traceroute targethost timeout verification successfull ###\n')


    def traceroute_targethost_ipoption(self):
        info('''\n########## test traceroute targethost ip-option ##########\n''')
        traceroute_targethost_ipoption_set = False
        s1 = self.net.switches[0]
        dump = s1.cmdCLI("traceroute localhost ip-option loosesourceroute 1.1.1.5")
        time.sleep(2)
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute to localhost' in line:
        ...
        info('\n### traceroute targethost ipoption verification successfull ###\n')
    ...
    def traceroute6_target_ipv6(self):
        ...
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 to 0:0::0:1' in line:
    ...
    def traceroute6_target_dstport(self):
        ...
        traceroute6_target_maxport_set = False
        s1 = self.net.switches[0]
        ...
        for line in lines:
            if 'traceroute6 to 0:0::0:1' in line:
                traceroute6_target_maxport_set = True
        assert(traceroute6_target_maxport_set is True), \
            'Test setting traceroute target maxport -FAILED!'
        info('\n### traceroute6 target ip maxport verification successfull ###\n')


    def traceroute6_target_minttl(self):
        info('''\n########## test traceroute6 target minttl ##########\n''')
        traceroute6_target_minttl_set = False
        s1 = self.net.switches[0]
        dump = s1.cmdCLI("traceroute6 0:0::0:1 minttl 1")
        time.sleep(2)
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute6 to 0:0:0::1' in line:
                traceroute6_target_minttl_set = True
        assert(traceroute6_target_minttl_set is True), \
            'Test setting traceroute6 target minttl -FAILED!'
        info('\n### traceroute6 target minttl verification successfull ###\n')
    ...
    def traceroute6_target_probes(self):
        ...
        info('\n### traceroute6 target ip probes verification successfull ###\n')
    ...
    def traceroute6_targethost_maxttl(self):
        info('''\n########## test traceroute6 targethost maxttl ##########\n''')
        ...
        info('\n### traceroute6 targethost maxttl verification successfull ###\n')


    def traceroute6_targethost_dstport(self):
        info('''\n########## Test traceroute6 targethhost dstport ##########\n''')
        ...
        info('\n### traceroute6 targethost maxport verification successfull ###\n')


    def traceroute6_targethost_minttl(self):
        info('''\n########## test traceroute6 targethost minttl ##########\n''')
        traceroute6_targethost_minttl_set = False
        s1 = self.net.switches[0]
        dump = s1.cmdCLI("traceroute6 localhost minttl 1")
        time.sleep(2)
        lines = dump.split('\n')
        for line in lines:
            if 'traceroute to localhost' in line:
                traceroute6_targethost_minttl_set = True
        assert(traceroute6_targethost_minttl_set is True), \
            'Test setting traceroute6host target minttl -FAILED!'
        info('\n### traceroute6 targethost minttl verification successfull ###\n')


    def traceroute6_targethost_probes(self):
        info('''\n########## Test traceroute6host target probes ##########\n''')
        traceroute6_target_probes_set = False
        s1 = self.net.switches[0]
        dump = s1.cmdCLI("traceroute localhost probes 3")
        time.sleep(2)
    ...
    def traceroute6_targethost_timeout(self):
        info('''\n########## test traceroutehost target timeout ##########\n''')
        ...
        info('\n### traceroute6 targethost timeout verification successfull ###\n''')
...
class Test_traceroute_cli:
    ...
    def test_traceroute6_target_minttl(self):
        self.test.traceroute6_target_minttl()
    ...
    def test_traceroute6_targethost_minttl(self):
        self.test.traceroute6_targethost_minttl()

    def test_traceroute6_targethost_timeout(self):
        self.test.traceroute6_targethost_timeout()

    def test_traceroute6_targethost_ipoption(self):
        self.test.traceroute6_targethost_ipoption()

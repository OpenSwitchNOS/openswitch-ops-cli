...
''')
        ...
        for line in lines:
            if 'hash l2-src-dst' in line:
                ...
                break
        assert success, \
            'Test (show run interface) LAG Load balancing for L2 - FAILED!'
        ...
        for line in lines:
            if 'hash l2vid-src-dst' in line:
                ...
                break
        assert success, \
            'Test (show run config) LAG Load balancing for L2+VID - FAILED!'
        ...
        for line in lines:
            if 'hash l2vid-src-dst' in line:
                ...
                break
        assert success, \
            'Test (show run intrf) LAG Load balancing for L2+VID - FAILED!'
        ...
        for line in lines:
            if 'Hash                  : l2vid-src-dst' in line:
                ...
                break
        assert success, \
            'Test (show lacp aggr) LAG Load balancing for L2+VID - FAILED!'
        ...
        success = True
        out = s1.cmdCLI('show running interfaces lag1')
        lines = out.split('\n')
        for line in lines:
            if 'hash l3-src-dst' in line:
                success = False
                break
        assert success, \
            'Test (show run interfaces) LAG Load balancing for L3 - FAILED!'
        ...
        for line in lines:
            if 'hash l4-src-dst' in line:
                ...
                break
        assert success, \
            'Test (show run interface) LAG Load balancing for L4 - FAILED!'

...
static int ecmp_config_set_status(bool status, const char * field)
{
    ...
    rc = smap_get_bool(&ovs_row->ecmp_config, field, ECMP_CONFIG_ENABLE_DEFAULT);
       ...
       ECMP_CONFIG_DISABLE_STR)
{
    ...
    return ecmp_config_set_status(false, ECMP_CONFIG_STATUS);
}
       ...
       "Disable load balancing by source IP\n")
{
    ...
    return ecmp_config_set_status(false, ECMP_CONFIG_HASH_SRC_IP);
}
       ...
       "Disable load balancing by destination IP\n")
{
    ...
    return ecmp_config_set_status(false, ECMP_CONFIG_HASH_DST_IP);
}
       ...
       "Disable load balancing by destination port\n")
{
    ...
    return ecmp_config_set_status(false, ECMP_CONFIG_HASH_DST_PORT);
}
       ...
       "Disable load balancing by source port\n")
{
    ...
    return ecmp_config_set_status(false, ECMP_CONFIG_HASH_SRC_PORT);
}
       ...
       ECMP_CONFIG_DISABLE_STR)
{
    ...
    return ecmp_config_set_status(true, ECMP_CONFIG_STATUS);
}
       ...
       "Disable load balancing by source IP\n")
{
    ...
    return ecmp_config_set_status(true, ECMP_CONFIG_HASH_SRC_IP);
}
...
{
    VLOG_DBG("Add hash option Destination IP");
    return ecmp_config_set_status(true, ECMP_CONFIG_HASH_DST_IP);
}
...
{
    VLOG_DBG("Add hash option Destination Port");
    return ecmp_config_set_status(true, ECMP_CONFIG_HASH_DST_PORT);
}
...
{
    VLOG_DBG("Add hash option Source Port");
    return ecmp_config_set_status(true, ECMP_CONFIG_HASH_SRC_PORT);
}

...
vtysh_context_client vtysh_dhcp_relay_context_client_list[e_vtysh_dhcp_relay_context_client_id_max] = {{NULL}};
...
vtysh_context_list vtysh_context_table[e_vtysh_context_id_max] =
{
  ...
  { "dhcp-relay Config", e_vtysh_dhcp_relay_context, &vtysh_dhcp_relay_context_client_list},
};
...
vtysh_context_get_maxclientid(vtysh_contextid contextid)
{
  ...
  switch(contextid)
  {
    ...
    case e_vtysh_sftp_server_context:
         ...
         break;
    case e_vtysh_dhcp_relay_context:
         ret_val = e_vtysh_dhcp_relay_context_client_id_max;
         break;
    default:
...
vtysh_context_get_minclientid(vtysh_contextid contextid)
{
  ...
  switch(contextid)
  {
    ...
    case e_vtysh_sftp_server_context:
         ...
         break;
    case e_vtysh_dhcp_relay_context:
         ret_val = e_vtysh_dhcp_relay_context_client_id_first;
         break;
    default:
         ret_val = e_vtysh_error;
         break;

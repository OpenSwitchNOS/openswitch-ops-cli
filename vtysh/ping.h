...
#define INPUT_DSIZE         "Enter Datagram size value in the range <100-65468>\n"
#define INPUT_COUNT         "Enter Repetition value in the range <1-10000>\n"
#define INPUT_INTERVAL      "Enter interval value in the range <1-60>\n"
#define INPUT_TIMEOUT       "Enter timeout value in the range <1-60>\n"
#define INPUT_TOS           "Enter tos value in the range <0-255>\n"

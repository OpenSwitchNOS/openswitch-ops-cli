...
class vrfCLITest( HalonTest ):
    ...
    def test_ip(self):
        ...
        expected_output = "Error: No IP Address configured " \
        ...
        expected_output = "Error: IP Address is already assigned to interface " \
                          + first_interface + " as primary."
    ...
    def test_ipv6(self):
        ...
        assert ipv6 == "2002::1/128", 'IPv6 address configuration failed'
        ...
        expected_output = "Error: IP Address is already assigned to interface " \
                          + first_interface + " as primary."
        assert expected_output in ret , 'IPv6 address duplicate check failed'
        ...
        ipv6 = s1.ovscmd(intf_cmd).strip()
        assert ipv6 == '[2001::2/128, 2001::3/128]', 'Secondary IPv6 address add failed'
        ...
        intf_cmd = "/usr/bin/ovs-vsctl get port " + first_interface + " ip6_address_secondary"
        ipv6 = s1.ovscmd(intf_cmd).strip()
        assert ipv6 == '[2001::3/128]', 'Secondary IPv6 address delete failed'
    ...
    def test_show_running_config(self):
        ...
        assert 'ip address 10.1.1.1/8' in output[intf2_output+1] and \
               ...
               'ipv6 address 2002::1/128' in output[intf2_output+3] and \
               'ipv6 address 2002::2/128 secondary' in output[intf2_output+4], \

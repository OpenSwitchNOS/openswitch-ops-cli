...
- [VRF Add/Delete](#vrf-adddelete)
	...
	- [Add VRF with name with maximum length allowed](#add-vrf-with-name-with-maximum-length-allowed)
...
- [IP address assign/remove](#ip-address-assignremove)
	...
	- [Assign multiple secondary IP address](#assign-multiple-secondary-ip-address)
	- [Remove multiple secondary IP address](#remove-multiple-secondary-ip-address)
...
- **CT file**: ops-cli/vtysh/tests/test_vtysh_ct_vrf.py (VRF & L3 Interface CLI)
...
###  Add VRF with name with maximum length allowed
#### Objective
...
###  Assign multiple secondary IP address
#### Objective
...
###  Remove multiple secondary IP address
#### Objective
...
#### Test Result Criteria
##### Test Pass Criteria
Port row must be created for interface 1.
IP and IPv6 addresses must be updated for the port.
Port must be added to default VRF.

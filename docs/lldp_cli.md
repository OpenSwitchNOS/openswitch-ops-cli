...
All users.
#### Parameters ####
<2-10> : Number of seconds to wait between 2 and 10.
#### Examples ####
> ops-as5712# configure terminal<br>
...
All users.
#### Parameters ####
(A.B.C.D | X:X::X:X) : Specify either IPV4 or IPV6 address to be set.
#### Examples ####
> ops-as5712# configure terminal<br>
...
All users.
#### Parameters ####
Either of the following TLVs:-<br>
...
All users.
#### Parameters ####
<5-32768> : Interval in seconds between 5 to 32768 seconds.
#### Examples ####
> ops-as5712# configure terminal<br>
...
#### Parameters ####
<!--Provide for the parameters for the command.-->
IFNAME : Interface for which statistics needed
#### Examples ####

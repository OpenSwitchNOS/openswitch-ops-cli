...
All interface configuration commands except "interface IFNAME" works in interface context.
...
All users.
#### Parameters ####
.LINE : String describing the interface.
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
All users.
#### Parameters ####
(auto|1000|10000|100000|40000) : Specify either of the following speed:-<br>
auto<br>
1000 Mbps<br>
10000 Mbps<br>
100000 Mbps<br>
...
auto<br>
<576-16360> (value between 576 to 16360)
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
All users.
#### Parameters ####
(half|full) : Either 'half' or 'full' duplex.
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
All users.
#### Parameters ####
(receive|send) : Receive or send pause frame
(off|on) : switch it on or off for the parameter mentioned above.
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
All users.
#### Parameters ####
(receive|send) : set 'receiving' or 'sending' pause frames to default state.
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
All users.
#### Parameters ####
(on|off) : set autonegotiation 'on' or 'off'
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
All users.
#### Parameters ####
A.B.C.D/M : IP address in the "A.B.C.D/M" format.
[secondary] : optional parameter which states ip address is secondary.
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
#### Parameters ####
A.B.C.D/M : IP address in the "A.B.C.D/M" format.
[secondary] : optional parameter which states ip address to remove is secondary.
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
All users.
#### Parameters ####
X:X::X:X/M : IPV6 address in the "X:X::X:X/M" format.
[secondary] : optional parameter which states ip address to set is secondary.
#### Examples ####
> ops-as5712# configure terminal<br>
ops-as5712(config)# interface 1<br>
...
All users.
#### Parameters ####
{brief} : optional 'brief' is specified to display data in tabular format.
#### Examples ####
...
All users.
#### Parameters ####
IFNAME : Interface to which neighbor is connected.
#### Examples ####

...
/* DEFUN_NON_IDL for the commands not accessing ovs-db idl */
...
#define DEFUNSH(daemon, funcname, cmdname, cmdstr, helpstr) \
 ...
 /* DEFUNSH_NON_IDL for the commands not accessing ovs-db idl */
...
#define NO_TUNNEL_STR       "Remove the tunnel config\n"
#define TUNNEL_KEY          "Set the tunnel key\n"
#define NO_TUNNEL_KEY       "Remove the tunnel key"
#define TUNNEL_NAME         "Tunnel name configuration\n"
#define TUNNEL_NAME_SET     "Set the vxlan tunnel name\n"
#define NO_TUNNEL_NAME      "Remove the vxlan tunnel name\n"
#define TUNNEL_DESCRIPTION  "Tunnel description configuration\n"
#define TUNNEL_DESCRIPTION_SET  "Set the tunnel description configuration\n"
#define NO_TUNNEL_DESCRIPTION  "Remove the tunnel description configuration\n"
#define TUNNEL_MCAST        "Tunnel multicast group ip configuration\n"
#define TUNNEL_MCAST_SET        "Set the tunnel multicast group ip configuration\n"
#define NO_TUNNEL_MCAST        "Remove the tunnel multicast group ip configuration\n"
#define IP_ADDR_HELP_STR      "ip address help string\n"
#define TUNNEL_IP_ADDR      "Tunnel ip address configuration\n"
#define TUNNEL_IP_ADDR_SET      "Set the tunnel ip address configuration\n"
#define NO_TUNNEL_IP_ADDR      "Remove the tunnel ip address configuration\n"
#define GLOBAL_VLAN_VNI     "Global vlan to vni mapping configuration\n"
#define NO_GLOBAL_VLAN_VNI     "Unset the global vlan to vni mapping configuration\n"
#define GLOBAL_VLAN         "Choosing the vlan\n"
#define GLOBAL_VLAN_NUMBER         "vlan number to be mapped\n"
#define GLOBAL_VNI         "Choosing the vni\n"
#define GLOBAL_VNI_NUMBER         "vni key to be mapped\n"
